...
CREATE TABLE `ordencompradetalle` (
  ...
  CONSTRAINT `ordencompradetalle_ibfk_1` FOREIGN KEY (`IdProducto`) REFERENCES `productos` (`IdProducto`),
  CONSTRAINT `ordencompradetalle_ibfk_2` FOREIGN KEY (`IdOrden`) REFERENCES `ordencompra` (`IdOrden`)
...
-- Dump completed on 2025-09-05 20:19:10
